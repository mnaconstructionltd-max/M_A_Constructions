...
const QuantityTakeoff: React.FC = () => {
  ...
  const features = [
    {
      title: "Architectural Takeoff",
      desc: "Accurate estimation for all architectural trades including walls, doors, windows, and finishes.",
      img: "/placeholder-arch.png",
      icon: ClipboardList,
    },
    {
      title: "Structural Takeoff",
      desc: "Detailed structural material estimation for beams, columns, slabs, and reinforcements.",
      img: "/placeholder-struct.png",
      icon: ArrowRight,
    },
    {
      title: "MEP Takeoff",
      desc: "Mechanical, Electrical, and Plumbing systems estimation for modern construction projects.",
      img: "/placeholder-mep.png",
      icon: ClipboardList,
    },
  ];
    ...
    <main className="bg-white text-black min-h-screen font-sans antialiased">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-gray-100 overflow-hidden">
        <div className="relative z-10 text-center px-4 py-20 max-w-5xl mx-auto">
          ...
          >
            Detailed takeoffs across all trades — architectural, structural, civil, mechanical, electrical, plumbing, roofing, flooring, and finishes.
          </p>
          <Button
            size="lg"
      ...
      >
        <div className="max-w-6xl mx-auto text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            High-precision takeoff and estimation services for modern construction projects.
          </p>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary to-accent">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="mb-8 text-lg">Contact us today for accurate takeoff and estimation services.</p>
          <Button
            size="lg"
