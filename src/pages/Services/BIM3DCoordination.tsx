  ...
  const services = [
    {
      ...
      desc: "Support for Invitations to Bid — scope analysis, proposal creation, quote comparison, and bid tabulation.",
      img: "/placeholder-bid.png",
      icon: ClipboardList,
    },
    {
      title: "BIM Coordination & 3D Modeling",
      desc: "BIM-based design validation, clash detection, model creation, and quantity extraction using Revit and Navisworks.",
      img: "/placeholder-bim.png",
      icon: ArrowRight,
    },
    {
      title: "Value Engineering & Cost Optimization",
      desc: "Evaluation of design alternatives and materials to achieve cost efficiency without compromising quality.",
      img: "/placeholder-value.png",
      icon: ClipboardList,
    },
    {
      title: "Remote Estimating & Outsourcing Support",
      desc: "Dedicated online estimating and project support for contractors requiring scalable, on-demand services.",
      img: "/placeholder-remote.png",
      icon: ArrowRight,
    },
  ];
    ...
    <main className="bg-white text-black min-h-screen font-sans antialiased">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-gray-100 overflow-hidden">
        <div className="relative z-10 text-center px-4 py-20 max-w-5xl mx-auto">
          ...
          >
            Complete support for bids, BIM coordination, value engineering, and remote estimating to keep your projects efficient and cost-effective.
          </p>
          <Button
            size="lg"
      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Professional services to streamline your bidding, BIM modeling, cost optimization, and remote estimating workflows.
          </p>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary to-accent">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="mb-8 text-lg">
            Contact us today for professional support in bidding, BIM, value engineering, and remote estimating services.
          </p>
          <Button
            size="lg"
